...
export class AppreciationForMePageStudent {
    ...
    getAppreciations(refresher?: any) {
        ...
        this.appreciationService.fetchAppreciationsStudentForMe(1)
            .subscribe((res: any) => {
    ...
    doInfinite(refresher: any) {
        ...
        this.appreciationService.fetchAppreciationsStudentForMe(this.pageNo + 1)
            .subscribe((res: any) => {
